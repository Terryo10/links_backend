                                    ...
                                    <form method="post" action="{{route("jobs.store")}}" autocomplete="off" enctype="multipart/form-data">
                                        ...
                                        <div class="pl-lg-4">
                                            ...
                                            <div class="form-group{{ $errors->has('Location') ? ' has-danger' : '' }}">
                                                ...
                                                <input type="Location" placeholder="Enter job position" name="name" id="input-price" class="form-control form-control-alternative{{ $errors->has('Location') ? ' is-invalid' : '' }}" value="" required>
                                                @include('alerts.feedback', ['field' => 'email'])
                                            </div>

                                            <div class="form-group{{ $errors->has('product_id') ? ' has-danger' : '' }}">
                                                <label class="form-control-label" for="input-qty">Type Of Job</label>
                                                <input type="text" name="type" placeholder="E.g full-time , partime ..." id="input-qty" class="form-control form-control-alternative{{ $errors->has('number_of_employees') ? ' is-invalid' : '' }}"  required>
